defmodule ExMonWeb.TrainerPokemonsController do
  ...
  defp handle_response({:error, _api_status, _reason} = error, _conn, _view, _status), do: error
  defp handle_response({:error, _reason} = error, _conn, _view, _status), do: error
end
